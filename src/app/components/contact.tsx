...
export default function Contact() {
    return (
      <div>
        ...
        {/* Contact Section */}
      <section className="py-10 bg-white sm:py-16 lg:py-24 justify-center">
                ...
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                  ...
                  <span className="absolute inset-x-0 bottom-0 border-b-[20px] border-yellow-500"></span>
                  <span className="relative text-3xl font-bold text-blue-950 sm:text-5xl lg:text-6xl">
                    Contact Us
                  </span>
                </div>
                     
                        <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-blue-950">Get in Touch with Our Experts to Elevate Your ICT Infrastructure and Ensure Seamless Business Operations.</p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                            <div className="overflow-hidden bg-white rounded-xl">
                                <div className="p-6">
                                    ...
                                    <p className="mt-6 text-lg font-medium text-blue-900">+263784596154</p>
                            ...
                            <div className="overflow-hidden bg-white rounded-xl">
                                <div className="p-6">
                                    ...
                                    <p className="mt-6 text-lg font-medium text-blue-900">service@kutakim.co.zw</p>
                            ...
                            <div className="overflow-hidden bg-white rounded-xl">
                                <div className="p-6">
                                    ...
                                    <p className="mt-6 text-lg font-medium leading-relaxed text-blue-900">Bulawayo, Zimbabwe</p>
                                    <p className="mt-2 text-lg font-medium leading-relaxed text-blue-900">Harare, Zimbabwe</p>
                            ...
                            <div className="px-6 py-12 sm:p-12">
                                ...
                                <form action="#" method="POST" className="mt-14">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                                        ...
                                        <div className="sm:col-span-2">
                                            <button type="submit" className="inline-flex items-center justify-center w-full px-4 py-4 mt-2 text-base font-semibold text-white transition-all duration-200 bg-blue-950 border border-transparent rounded-md focus:outline-none hover:bg-yellow-400 focus:bg-blue-950">
                                                Send
                                            </button>
                                        </div>
                                    </div>
